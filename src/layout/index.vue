<template>
  <div :class="classObj" class="app-wrapper" :style="{'--current-color': $store.state.settings.theme}">
    ...
    <div :class="{hasTagsView:needTagsView}" class="main-container m-container">
      <div :class="{'fixed-header':fixedHeader}">
        <navbar />
        <tags-view v-if="needTagsView" />
      </div>
      <app-main />
      <div style="display: flex;justify-content: center;align-items: center;height: 30px;background: #fff">
        <a> 2024 © 融视科技 版权所有. </a>
      </div>
