    ...
    <template #wrapper>
      <el-row :gutter="20" style="height: 100%">
        ...
        <el-col :span="20" :xs="24" style="height: 100%; display: flex;flex-direction: column">
          ...
          <el-row :gutter="10" class="mb8" style="transform: translateY(-10px)">
            <el-col :span="1.5">
              <el-button
          ...
          <div style="flex: 1">
            ...
            >
              ...
              <el-table-column label="编号" width="90" prop="userId" sortable="custom" />
              <el-table-column label="登录名" width="105" prop="username" sortable="custom" :show-overflow-tooltip="true" />
              <el-table-column label="昵称" prop="nickName" width="80" :show-overflow-tooltip="true" />
              <el-table-column label="部门" prop="dept.deptName" width="100" :show-overflow-tooltip="true" />
...
<!--            </el-col>-->
            <el-col :span="12">
              <el-form-item label="角色">
                <el-select multiple v-model="form.roleIds" placeholder="请选择" @change="$forceUpdate()">
                  <el-option
