<template>
  <BasicLayout>
    <template #header>
      <el-form ref="queryForm" :model="queryParams" :inline="true" style="transform: translateY(10px)">
    ...
    <template #wrapper>
      ...
      <div style="flex: 1">
        <el-table :height="'98%'" v-loading="loading" :data="dataList" border @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      // this.queryParams['dictSortOrder'] = 'desc'
